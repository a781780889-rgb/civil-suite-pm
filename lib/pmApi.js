...
export const ROLE_LABELS = {
  ...
  supervisor: 'المشرف', accountant: 'المحاسب', quality_officer: 'مسؤول الجودة', safety_officer: 'مسؤول/مهندس السلامة',
  ...
  // القسم السادس: نظام إدارة الأعمال
  business_manager: 'مدير الأعمال', contracts_officer: 'مسؤول العقود', procurement_officer: 'مسؤول المشتريات',
  // القسم السابع: نظام إدارة المعدات
  equipment_manager: 'مدير المعدات', maintenance_officer: 'مسؤول الصيانة', warehouse_keeper: 'أمين المخزن', operator: 'المشغل',
  hse_manager: 'مدير السلامة', // القسم الثامن: نظام إدارة السلامة المهنية
};
