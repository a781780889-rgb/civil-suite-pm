...
import { listReservations, createReservation } from '@/lib/equipment/db/reservations.js';
...
export async function POST(request) {
  try {
    ...
    const reservation = createReservation(body, actor);
