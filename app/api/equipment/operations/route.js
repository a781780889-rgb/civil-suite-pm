...
import { listOperationLogs, createOperationLog } from '@/lib/equipment/db/operations.js';
...
export async function GET(request) {
  try {
    ...
    const data = listOperationLogs({
      equipment_id: searchParams.get('equipment_id') || undefined, project_id: searchParams.get('project_id') || undefined,
      operator_id: searchParams.get('operator_id') || undefined, from: searchParams.get('from') || undefined, to: searchParams.get('to') || undefined,
...
export async function POST(request) {
  try {
    ...
    const log = createOperationLog(body, actor);
