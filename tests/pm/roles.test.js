...
describe('مصفوفة الصلاحيات — قواعد أساسية', () => {
  ...
  test('كل الأدوار الاثنين والعشرين معرّفة في المصفوفة (لا دور بلا صلاحيات معرّفة)', () => {
    ...
    // + equipment_manager/maintenance_officer/warehouse_keeper/operator (القسم السابع) = 22
